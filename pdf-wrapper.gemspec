Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("pdf-reader", "~> 0.9.0")

  spec.add_dependency("cairo", "~>1.8")
  spec.add_dependency("gtk2", ">= 0.90.5", "~> 1.0.0")
  spec.add_dependency("glib2", ">= 0.90.5", "~> 1.0.0")
  spec.add_dependency("pango", ">= 0.90.5", "~> 1.0.0")
  spec.add_dependency("poppler", ">= 0.90.5", "~> 1.0.0")
  spec.add_dependency("gdk_pixbuf2", ">= 0.90.5", "~> 1.0.0")
  spec.add_dependency("rsvg2", ">= 0.90.5", "~> 1.0.0")
end
