...
These are all ruby bindings to C libraries - all but rsvg2 are loaded using
rubygems. On Debian/Ubuntu based systems (which I develop on) you can get rsvg2
by running:

    aptitude install librsvg2-ruby
